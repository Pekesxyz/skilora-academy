  ...
  return (
    <div className="faq py-5">
      <Container>
        ...
        <Row className="row-cols-lg-2 row-cols-1 g-3 mb-5">
          {faq.map((data) => {
            return (
              <Col key={data.id}>
                <Accordion className="rounded-2 border overflow-hidden faq-accordion">
        ...
        <Row className="justify-content-center">
          <Col lg="10">
            <div className="help-box p-4 p-md-5 rounded-3 border bg-white d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
              <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="btn btn-success px-4 py-2 rounded-3 fw-semibold text-nowrap d-flex align-items-center gap-2"
              >
