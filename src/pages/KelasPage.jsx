          ...
          <Row className="justify-content-center text-center">
            <Col lg="8">
              ...
              <div className="search-box-wrap mx-auto mt-4 position-relative" style={{ maxWidth: "600px" }}>
                <div className="input-group input-group-lg rounded-3 overflow-hidden border">
              ...
              <div className="category-pills-wrap d-flex flex-wrap justify-content-center gap-2 mt-4">
                {categories.map((cat, idx) => (
                  <button
                    key={idx}
                    className={`btn btn-sm rounded-2 px-3 py-2 fw-semibold transition-all ${
        ...
        <Container>
          ...
          {filteredCourses.length > 0 ? (
            ...
            <div className="empty-state text-center py-5 my-5">
              ...
              <button
                className="btn btn-outline-danger rounded-3 px-4 mt-2"
                onClick={() => {
                  setSearchQuery("");
                  setSelectedCategory("Semua");
                }}
